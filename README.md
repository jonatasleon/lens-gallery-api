...
## Development environment and release process
 ...
 - create virtualenv with Flask and api installed into it (latter is installed in
...
install it (`pip install api.tar.gz`), ensure that configuration file exists and
